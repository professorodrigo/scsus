...
$result = $db->query("SELECT * FROM diabeticos WHERE id = '".$_SESSION['login']."'");
while($array = $result->fetchArray(SQLITE3_ASSOC)){
	$dti = $array['dti'];
	$dtf = $array['dtf'];
	$gpa = $array['gpa'];
...
// -----------------------------------------------------------------------
$file = "html/rel_diabeticos_".$_SESSION['login'].".html";
if (file_exists($file)){unlink($file);}
$HTML = fopen($file,'w');
// -----------------------------------------------------------------------
$file = "csv/diabeticos_T_".$_SESSION['login'].".csv";
if (file_exists($file)){unlink($file);}
$FT = fopen($file,'w');
...
if ($paginacao <= 0 || $nm_sql_2 == 0){
	...
	$file = "resumo/r_ind7_".$_SESSION['login'].".php";
	if (file_exists($file)){unlink($file);}
	$FIN = fopen($file,'w');
	$porc_ind = 0;
