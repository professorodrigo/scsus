...
?>
  ...
  <div class="content-wrapper">
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item active">Diabéticos</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
    ...
    <section class="content">
      <div class="container-fluid">
	  <form action="gv_diabeticos.php" method="post" id="formdi" name="formdi">
        <div class="row">
          <!-- left column -->
          <div class="col-md-6">
            <!-- jquery validation -->
            <div class="card card-success">
              <div class="card-header">
                <h3 class="card-title">Diabéticos <small>- dados para geração dos relatórios</small></h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
...
$(function () {
  ...
  $('#formdi').validate({
	submitHandler: function (form) {
		$.post('gv_diabeticos.php', $('#formdi').serialize(), function (data, textStatus) {
